...
- Name: ProductList.spec.ts >> TTA Cart - Product List Page Tests >> DATA-007 - Verify Add to Cart button availability | Expected: Add to Cart should be present, visible, and enabled for each eligible product.
- Location: src\tests\ProductList.spec.ts:71:9
