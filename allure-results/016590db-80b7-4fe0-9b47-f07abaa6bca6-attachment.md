...
- Name: ProductDetails.spec.ts >> TTACart - Product Details Page >> DETAILS-001 - Verify a product detail page displays the selected product
- Location: src\tests\ProductDetails.spec.ts:10:9
