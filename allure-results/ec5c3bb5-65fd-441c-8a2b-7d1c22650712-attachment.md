...
```ts
  ...
  18  |         const productCards = page.locator('[data-testid="inventory-item"]');
  ...
  28  |         const descriptions = await page.locator('[data-testid="inventory-item-description"]').allTextContents();
  ...
  35  |         const prices = await page.locator('[data-testid="inventory-item-price"]').allTextContents();
  ...
  42  |         const priceTexts = await page.locator('[data-testid="inventory-item-price"]').allTextContents();
  43  | 
  ...
  50  |         const productCard = page.locator('[data-testid="inventory-item"]').first();
  ...
  58  |         const images = page.locator('[data-testid="inventory-item"] img');
...
> 61  |         expect(count).toBeGreaterThan(0);
  ...
  72  |         const productCards = page.locator('[data-testid="inventory-item"]');
  ...
  86  | 
  87  |         const productNames = (await page.locator('[data-testid="inventory-item"] a').allTextContents()).map((name) => name.trim());
  ...
  95  | 
  96  |         const productNames = (await page.locator('[data-testid="inventory-item"] a').allTextContents()).map((name) => name.trim());
  ...
  104 | 
  105 |         const prices = (await page.locator('[data-testid="inventory-item-price"]').allTextContents()).map((price) => Number.parseFloat(price.replace(/[^0-9.]/g, '')));
  ...
  113 | 
  114 |         const prices = (await page.locator('[data-testid="inventory-item-price"]').allTextContents()).map((price) => Number.parseFloat(price.replace(/[^0-9.]/g, '')));
  ...
  121 |         const firstProduct = page.locator('[data-testid="inventory-item"]').first();
  ...
  125 |         await expect(page.locator('.shopping_cart_badge')).toHaveText('1');
  ...
  131 |         const firstProduct = page.locator('[data-testid="inventory-item"]').first();
  132 | 
  133 |         await firstProduct.getByRole('button', { name: 'Add to cart' }).click();
  134 |         await expect(page.locator('.shopping_cart_badge')).toHaveText('1');
  135 |     });
  136 | 
  ...
  138 |         const productCard = page.locator('[data-testid="inventory-item"]').first();
  139 |         const productName = (await productCard.locator('a').first().textContent())?.trim() ?? '';
  140 |         const productDescription = (await productCard.locator('[data-testid="inventory-item-description"]').textContent())?.trim() ?? '';
  141 |         const productPrice = (await productCard.locator('[data-testid="inventory-item-price"]').textContent())?.trim() ?? '';
  142 | 
  ...
  153 |         const productCards = page.locator('[data-testid="inventory-item"]');
