...
- Name: ProductList.spec.ts >> TTA Cart - Product List Page Tests >> CART-001 - Verify a product can be added to the shopping cart | Expected: The selected product should be added successfully and the cart indicator should update.
- Location: src\tests\ProductList.spec.ts:120:9
