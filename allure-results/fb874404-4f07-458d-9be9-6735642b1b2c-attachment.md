...
Locator: locator('[data-testid="inventory-item"]').first().locator('img')
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('[data-testid="inventory-item"]').first().locator('img') with timeout 10000ms
  - waiting for locator('[data-testid="inventory-item"]').first().locator('img')
