...
- Name: ProductDetails.spec.ts >> TTACart - Product Details Page >> DETAILS-003 - Verify Back returns to the product list
- Location: src\tests\ProductDetails.spec.ts:26:9
